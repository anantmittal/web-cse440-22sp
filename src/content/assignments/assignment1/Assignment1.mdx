...
- [Assignment 1a: Individual Proposal Brainstorm](#id-1a-individual-proposal-brainstorm)

  <p><CourseInformationDueDate dueDateName='dueDateAssignment1a' /></p>

- [Assignment 1b: Group Project Proposals](#id-1b-group-project-proposals)

  <p><CourseInformationDueDate dueDateName='dueDateAssignment1b' /></p>

- [Assignment 1c: Finalized Group Project Proposal](#id-1c-finalized-group-project-proposal)

  <p><CourseInformationDueDate dueDateName='dueDateAssignment1c' /></p>
...
### 1a: Individual Proposal Brainstorm
...
<p><CourseInformationLink linkName='linkCanvasAssignment1a' /></p>
...
1. __Each Unique Proposed Idea__: (1 point)

   Do not submit small variations on the same idea.

As noted above, at most one of your ideas may come from the domains listed above (i.e., finances, wellness, health, mood).

### 1b: Group Project Proposals
...
Friday's section will then include presenting these for feedback from peers and course staff.
...
This is a group submission. Ensure your section and names of all group participants are at the top of your submission.
...
<p><CourseInformationLink linkName='linkCanvasAssignment1b' /></p>

#### Grading

This milestone will be graded on a scale of __10 points__:

1. __Problem and Motivation for Each Unique Proposed Idea__: (2 points)
...
### 1c: Finalized Group Project Proposal
...
<p><CourseInformationLink linkName='linkCanvasAssignment1c' /></p>
