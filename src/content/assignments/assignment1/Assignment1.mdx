...
- [Assignment 1a: Individual Brainstorm](#id-1a-individual-brainstorm)

  <p><CourseInformationDueDate dueDateName='dueDateAssignment1a' /></p>

- [Assignment 1b: Group Proposals](#id-1b-group-proposals)

  <p><CourseInformationDueDate dueDateName='dueDateAssignment1b' /></p>

- [Assignment 1c: Revised Proposal](#id-1c-revised-proposal)
